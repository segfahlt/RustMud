...
Single currency: **gold coins** (gp).

| Store | Location | Notes |
|-------|----------|-------|
| Carried gold | Player inventory | Lost on death (drops on corpse) |
| Bank balance | Per-character persistent | Safe, accessible at bank rooms only |

No platinum/silver tiering to start — simplicity wins until we know the economy shape.
...
A player rents a stand in a designated market room. They stock it with items and set prices. Items sell to other players while the owner is offline.
...
4. Purchase: `buy <item> from <player>` — gold transferred immediately, item goes to buyer inventory
...
4. Winner: item transferred, gold deducted
5. Outbid players: gold immediately returned
...
- Mob gold drops should be the primary income source for new characters
- Rare items should have low drop rates to maintain auction value
- Vendor markdown (40%) creates a meaningful floor without being a gold sink
- Death (dropping carried gold) is the primary gold sink; banking mitigates but doesn't eliminate it
